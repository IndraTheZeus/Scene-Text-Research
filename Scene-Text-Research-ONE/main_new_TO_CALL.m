...
%  GT_dir = 'E:\ResearchFiles\DATA\DATASET-FOR-SCENE-TEXT-TRAINING\Benchmarking_word_image_datasets\Benchmarking_word_image_datasets\ICDAR03\ICDAR03\icdar03_ground_truth\';
...
input_dir ='E:\ResearchFiles\DATA\test_input\';
output_dir = 'E:\ResearchFiles\DATA\test_output\';
% % load('DensityPixelsRemovedEnsemble.mat')

batchFormation(input_dir,strcat(output_dir,'Paper\'),'jpg','png',IC03_5)
