 ...
 for i = 1:numel(BinSizes)
   ...
   fprintf("Mapping Image to Bin Size: %d\n",BinSizes(i));
   for r = 1:row
        for c = 1:col
     
       value = rgbDistance(image(r,c,1),image(r,c,2),image(r,c,3));
       
         x = q_offset+floor(value/BinSizes(i))+1;
          rgb_BinImages(r,c,x) = 1;
         if value>k && value<MAX_DISTANCE-k
 ...
 rgb_BinImages = ReduceToMainCCs(rgb_BinImages);   % Remove to small points
